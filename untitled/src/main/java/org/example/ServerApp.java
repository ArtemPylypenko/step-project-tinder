...
public class ServerApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        handler.addServlet(new ServletHolder(new UsersServlet("static-content", dao)), "/users/*");
        handler.addServlet(new ServletHolder(new LikedServlet("static-content", dao)), "/liked/*");
